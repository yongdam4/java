...
public class Operator4 {
	 ...
	 * 비교연산자 / 관계연산자
	 * 두값을 비교하는 연산자
	 * 비교 연산자는 조건을 만족하면 true(참), 만족하지않으면 false(거짓)을 반환
	 * 즉, 비교연산의 결과는 논리값
	 * 
	 * 대소비교연산 : < > <= >=
	 * 동등비교연산 : == !=
	 * 
	 * 원시타입 일반변수 => 동등비교를 통해 == != 으로 진행하면 된다.
	 * 
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("첫번째가 두번째보다 큽니다 : " + (i1 > i2));
		
		System.out.println("첫번째 정수는 짝수 입니다 : " + (i1 % 2 == 0));
		*/
