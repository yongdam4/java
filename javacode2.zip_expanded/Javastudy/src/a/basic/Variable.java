...
public class Variable {
	...
	public static void main(String[] args) {
		...
		/*
		 *  이스케이프 시퀀스
		 *  문자열 내에서 탭,백슬래시, 작은따음표등을 코드로 사용하기위한 방식
		 *  
		 *  탭문자 \t
		 *  백슬래시 \\
		 *  작은따옴표 \'
		...
		//포멧 안에서 쓸수 있는 키워드는 정수=%d, 문자=%c, 문자열=%s, 실수=%f(소수점 아래로 원하는 만큼 표시하기 위해서는 %.nf) 이다
		//ex) System.out.printf("안녕하세요 저는 %s 입니다.", "김용담");

		//위 두 문장은 둘다 "안녕하세요 저는 김용담입니다" 가 나온다
