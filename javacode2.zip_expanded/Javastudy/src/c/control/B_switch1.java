...
public class B_switch1 {
	...
	public static void main(String[] args) {
		...
		//월을 입력받아 해당월에 말일이 며칠까지있는지를 출력하는 프로그램 작성
		...
		switch(fr) {
		case "사과":
			System.out.println("사과의 가격은 2000입니다.");
		    break;
		case "바나나":
			System.out.println("바나나의 가격은 3000입니다.");
			break;
		case "딸기":
			System.out.println("딸기의 가격은 5000입니다.");
			break;
		default:
